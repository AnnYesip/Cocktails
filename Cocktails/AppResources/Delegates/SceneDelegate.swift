...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    secVC.tabBarItem = UITabBarItem(tabBarSystemItem: .favorites, tag: 0)
    thirdVC.tabBarItem = UITabBarItem(tabBarSystemItem: .search, tag: 0)
    tabBarController.viewControllers = [navController, secVC, thirdVC]
